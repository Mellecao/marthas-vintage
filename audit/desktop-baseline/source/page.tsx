...
function CollectionFrame() {
  return (
    <section className="design-frame collection-frame" aria-label="The collection">
      ...
      <p className="section-kicker personal-kicker">Personal</p>
      <h2 className="display-word personal-word">style</h2>
      <span className="personal-rule-top" aria-hidden="true" />
      <span
        className="personal-rule-bottom personal-rule-bottom-left"
        aria-hidden="true"
      />
      <span
        className="personal-rule-bottom personal-rule-bottom-right"
        aria-hidden="true"
      />
    </section>
  );
